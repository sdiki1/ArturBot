...
DEFAULT_TEXTS: dict[str, str] = {
    ...
    "entry.fee": "Стоимость вступления: 100₽",
    ...
    "web.admin_broadcast_title": "Рассылка пользователям",
    "web.admin_broadcast_hint": "Отправка по всем пользователям бота. Фото можно указать ссылкой Telegram file_id или URL.",
    "web.admin_broadcast_text_label": "Текст сообщения",
    "web.admin_broadcast_photo_label": "Фото (необязательно)",
    "web.admin_broadcast_send_btn": "Отправить рассылку",
