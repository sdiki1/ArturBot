...
DEFAULT_TEXTS: dict[str, str] = {
    ...
    "photos.slot_caption": "Фото слот {slot}",
    "photos.choose_slot": "Выберите слот для изменения.",
    "photos.ask_new_slot": "Отправьте новое фото для слота {slot}.",
    "photos.updated": "Фото {slot} успешно обновлено.",
    "photos.expected_photo": "Пожалуйста, отправьте фото для выбранного слота.",
    ...
    "kb.photo_change_template": "Изменить мое фото {slot}",
    "kb.broadcast_yes": "✅ Да",
    "kb.broadcast_no": "❌ Нет",
